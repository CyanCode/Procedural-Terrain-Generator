...
namespace JBooth.VertexPainterPro
{
   public partial class VertexPainterWindow : EditorWindow 
   {
      ...
      void DrawPaintGUI()
      {
         ...
         var oldBM = brushMode;
         brushMode = (BrushTarget)EditorGUILayout.Popup("Target Channel", (int)brushMode, brushTargetNames);
         if (oldBM != brushMode)
         {
            UpdateDisplayMode();
         }
      ...
      void DrawFlowGUI()
      {
         ...
         var ft = flowTarget;
         flowTarget = (FlowTarget)EditorGUILayout.Popup("Target", (int)flowTarget, flowTargetNames);
         if (flowTarget != ft)
         {
            UpdateDisplayMode();
         }
