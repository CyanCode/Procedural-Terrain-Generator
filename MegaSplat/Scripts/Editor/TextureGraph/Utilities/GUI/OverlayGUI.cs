...
namespace JBooth.MegaSplat.NodeEditorFramework 
{
	...
	public class PopupMenu 
	{
		...
		public void SetupGUI () 
		{
         ...
         expandRight = JBooth.MegaSplat.NodeEditorFramework.ResourceManager.LoadTexture ("Resources/Textures/expandRight");
			itemHeight = GUI.skin.label.CalcHeight (new GUIContent ("text"), 100);
			
			selectedLabel = new GUIStyle (GUI.skin.label);
			selectedLabel.normal.background = JBooth.MegaSplat.NodeEditorFramework.RTEditorGUI.ColorToTex (1, new Color (0.4f, 0.4f, 0.4f));
		}
		...
		public void Draw () 
		{
			...
			JBooth.MegaSplat.NodeEditorFramework.NodeEditor.RepaintClients ();
		}
