...
namespace JBooth.MegaSplat.NodeEditorFramework 
{
	public static class NodeEditorGUI 
	{
		...
		{
			// Textures
         Background = ResourceManager.LoadTexture ("Resources/Textures/background");
         AALineTex = ResourceManager.LoadTexture ("Resources/Textures/AALine");
         GUIBox = ResourceManager.LoadTexture ("Resources/Textures/NE_Box");
         GUIButton = ResourceManager.LoadTexture ("Resources/Textures/NE_Button");
         GUIBoxSelection = ResourceManager.LoadTexture ("Resources/Textures/BoxSelection");
		...
		public static void DrawConnection (Vector2 startPos, Vector2 startDir, Vector2 endPos, Vector2 endDir, ConnectionDrawMethod drawMethod, Color col) 
		{
			if (drawMethod == ConnectionDrawMethod.Bezier) 
			{
				...
				RTEditorGUI.DrawBezier (startPos, endPos, startPos + startDir * dirFactor, endPos + endDir * dirFactor, col * Color.gray, null, 5);
			}
			else if (drawMethod == ConnectionDrawMethod.StraightLine)
				RTEditorGUI.DrawLine (startPos, endPos, col * Color.gray, null, 5);
		}
