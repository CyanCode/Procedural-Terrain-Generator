...
namespace JBooth.MegaSplat.NodeEditorFramework
{
	public abstract class Node : ScriptableObject
	{
      ...
      public virtual void SetProperties(Material mat) { }
        ...
        /// </summary>
        protected internal virtual bool DrawNode () 
		{
         ...
         RTEditorGUI.BeginChangeCheck();
			NodeGUI ();
         bool ret = (RTEditorGUI.EndChangeCheck());
			// End NodeGUI frame
			GUILayout.EndArea ();
			GUI.EndGroup ();
         return ret;
      ...
      public void WriteInputs()
      {
         ...
         for (int i = 0; i < Inputs.Count; ++i)
         {
            ...
            {
               ip.connection.body.WriteInputs();
            }
         }
      ...
      public void ActivateProperties(Material mat)
      {
         SetProperties(mat);
         for (int i = 0; i < Inputs.Count; ++i)
         {
            ...
            if (ip.connection != null)
            {
               ip.connection.body.ActivateProperties(mat);
            }
         }

      }

      protected string GetOrDefault(int idx, string def)
      {
         if (idx < Inputs.Count && Inputs[idx].connection != null)
         {
            return Inputs[idx].connection.varName;
         }
         return def;
      }
