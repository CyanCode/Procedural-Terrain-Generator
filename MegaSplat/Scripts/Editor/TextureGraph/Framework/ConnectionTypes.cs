...
namespace JBooth.MegaSplat.NodeEditorFramework
{
	...
	public class TypeData 
	{
		...
		public TypeData (Type type) 
		{
         ...
         InKnobTex = ResourceManager.GetTintedTexture ("Resources/Textures/In_Knob", Color);
         OutKnobTex = ResourceManager.GetTintedTexture ("Resources/Textures/Out_Knob", Color);
		}
	...
	public class FloatType : IConnectionTypeDeclaration 
	{
      ...
      public Color Color { get { return Color.cyan; } }
		public string InKnobTex { get { return "Resources/Textures/In_Knob"; } }
		public string OutKnobTex { get { return "Resources/Textures/Out_Knob"; } }
	}
